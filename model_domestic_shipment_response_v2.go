...
type DomesticShipmentResponseV2 struct {
	...
	LabelLayout []DomesticShipmentResponseV2LabelLayoutInner `json:"labelLayout,omitempty"`
	...
	ToAddress *ToAddressV2Response `json:"toAddress,omitempty"`
...
func (o *DomesticShipmentResponseV2) GetLabelLayout() []DomesticShipmentResponseV2LabelLayoutInner {
	if o == nil || IsNil(o.LabelLayout) {
		var ret []DomesticShipmentResponseV2LabelLayoutInner
		return ret
	}
...
// SetLabelLayout gets a reference to the given []DomesticShipmentResponseV2LabelLayoutInner and assigns it to the LabelLayout field.
...
// SetToAddress gets a reference to the given ToAddressV2Response and assigns it to the ToAddress field.
