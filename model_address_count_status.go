...
// checks if the AddressCountStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddressCountStatus{}

// AddressCountStatus This indicates the status count of addresses which are at validation stage.
type AddressCountStatus struct {
...
func (o AddressCountStatus) MarshalJSON() ([]byte, error) {
...
func (o AddressCountStatus) ToMap() (map[string]interface{}, error) {
...
type NullableAddressCountStatus struct {
	value *AddressCountStatus
	isSet bool
}

func (v NullableAddressCountStatus) Get() *AddressCountStatus {
	return v.value
}

func (v *NullableAddressCountStatus) Set(val *AddressCountStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAddressCountStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAddressCountStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddressCountStatus(val *AddressCountStatus) *NullableAddressCountStatus {
	return &NullableAddressCountStatus{value: val, isSet: true}
}

func (v NullableAddressCountStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddressCountStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
