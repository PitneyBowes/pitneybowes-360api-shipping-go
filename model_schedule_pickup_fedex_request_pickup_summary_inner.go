...
type _SchedulePickupFedexRequestPickupSummaryInner SchedulePickupFedexRequestPickupSummaryInner
...
func (o *SchedulePickupFedexRequestPickupSummaryInner) UnmarshalJSON(data []byte) (err error) {
	...
	varSchedulePickupFedexRequestPickupSummaryInner := _SchedulePickupFedexRequestPickupSummaryInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSchedulePickupFedexRequestPickupSummaryInner)

	if err != nil {
		return err
	}

	*o = SchedulePickupFedexRequestPickupSummaryInner(varSchedulePickupFedexRequestPickupSummaryInner)
