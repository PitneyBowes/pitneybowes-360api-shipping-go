...
type SchedulePickupFedexRequest struct {
	...
	PickupOptions SchedulePickupFedexRequestPickupOptions `json:"pickupOptions"`
}

type _SchedulePickupFedexRequest SchedulePickupFedexRequest
...
func (o *SchedulePickupFedexRequest) GetPickupOptions() SchedulePickupFedexRequestPickupOptions {
	if o == nil {
		var ret SchedulePickupFedexRequestPickupOptions
		return ret
	}
...
func (o *SchedulePickupFedexRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSchedulePickupFedexRequest := _SchedulePickupFedexRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSchedulePickupFedexRequest)

	if err != nil {
		return err
	}

	*o = SchedulePickupFedexRequest(varSchedulePickupFedexRequest)
