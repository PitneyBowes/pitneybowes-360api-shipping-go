...
type GetStatusDetailedResponse struct {
	...
	Import ImportCountStatus `json:"import,omitempty"`
	AddressValidation AddressCountStatus `json:"addressValidation,omitempty"`
	Rating RatingCountStatus `json:"rating,omitempty"`
	LabelGeneration LabelGenerationCountStatus `json:"labelGeneration,omitempty"`
	VoidLabel VoidCountStatus `json:"voidLabel,omitempty"`
...
func (o *GetStatusDetailedResponse) GetImportOk() (ImportCountStatus, bool) {
	if o == nil || IsNil(o.Import) {
		return ImportCountStatus{}, false
	}
...
// SetImport gets a reference to the given ImportCountStatus and assigns it to the Import field.
...
func (o *GetStatusDetailedResponse) GetRatingOk() (RatingCountStatus, bool) {
	if o == nil || IsNil(o.Rating) {
		return RatingCountStatus{}, false
	}
...
// SetRating gets a reference to the given RatingCountStatus and assigns it to the Rating field.
...
// SetVoidLabel gets a reference to the given VoidCountStatus and assigns it to the VoidLabel field.
