...
// checks if the ToAddressV2Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ToAddressV2Response{}

// ToAddressV2Response The complete address of the Sender.
type ToAddressV2Response struct {
...
func (o ToAddressV2Response) MarshalJSON() ([]byte, error) {
...
func (o ToAddressV2Response) ToMap() (map[string]interface{}, error) {
...
type NullableToAddressV2Response struct {
	value *ToAddressV2Response
	isSet bool
}

func (v NullableToAddressV2Response) Get() *ToAddressV2Response {
	return v.value
}

func (v *NullableToAddressV2Response) Set(val *ToAddressV2Response) {
	v.value = val
	v.isSet = true
}

func (v NullableToAddressV2Response) IsSet() bool {
	return v.isSet
}

func (v *NullableToAddressV2Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableToAddressV2Response(val *ToAddressV2Response) *NullableToAddressV2Response {
	return &NullableToAddressV2Response{value: val, isSet: true}
}

func (v NullableToAddressV2Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableToAddressV2Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
