...
type RateResponseV2 struct {
	...
	DeliveryCommitment *RateResponseV2DeliveryCommitment `json:"deliveryCommitment,omitempty"`
}
...
func (o *RateResponseV2) GetDeliveryCommitment() RateResponseV2DeliveryCommitment {
	if o == nil || IsNil(o.DeliveryCommitment) {
		var ret RateResponseV2DeliveryCommitment
		return ret
	}
...
// SetDeliveryCommitment gets a reference to the given RateResponseV2DeliveryCommitment and assigns it to the DeliveryCommitment field.
