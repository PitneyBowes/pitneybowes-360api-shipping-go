...
type _SchedulePickupUSPSRequest SchedulePickupUSPSRequest
...
func (o *SchedulePickupUSPSRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSchedulePickupUSPSRequest := _SchedulePickupUSPSRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSchedulePickupUSPSRequest)

	if err != nil {
		return err
	}

	*o = SchedulePickupUSPSRequest(varSchedulePickupUSPSRequest)
