...
func Test_shipping_ShipmentAPIService(t *testing.T) {
	...
	t.Run("Test ShipmentAPIService DownloadBpodFiles", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.ShipmentAPI.DownloadBpodFiles(context.Background()).Execute()
	...
	t.Run("Test ShipmentAPIService GetSignatureImageERR", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var shipmentId string

		resp, httpRes, err := apiClient.ShipmentAPI.GetSignatureImageERR(context.Background(), shipmentId).Execute()
