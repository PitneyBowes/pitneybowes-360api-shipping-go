...
// checks if the MultipieceDomesticShipmentRequestToAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultipieceDomesticShipmentRequestToAddress{}

// MultipieceDomesticShipmentRequestToAddress struct for MultipieceDomesticShipmentRequestToAddress
type MultipieceDomesticShipmentRequestToAddress struct {
...
type _MultipieceDomesticShipmentRequestToAddress MultipieceDomesticShipmentRequestToAddress
...
func NewMultipieceDomesticShipmentRequestToAddress(addressLine1 string, countryCode string, postalCode string, stateProvince string) *MultipieceDomesticShipmentRequestToAddress {
	this := MultipieceDomesticShipmentRequestToAddress{}
...
func (o MultipieceDomesticShipmentRequestToAddress) MarshalJSON() ([]byte, error) {
...
func (o MultipieceDomesticShipmentRequestToAddress) ToMap() (map[string]interface{}, error) {
...
func (o *MultipieceDomesticShipmentRequestToAddress) UnmarshalJSON(data []byte) (err error) {
	...
	varMultipieceDomesticShipmentRequestToAddress := _MultipieceDomesticShipmentRequestToAddress{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMultipieceDomesticShipmentRequestToAddress)

	if err != nil {
		return err
	}

	*o = MultipieceDomesticShipmentRequestToAddress(varMultipieceDomesticShipmentRequestToAddress)

	return err
}

type NullableMultipieceDomesticShipmentRequestToAddress struct {
	value *MultipieceDomesticShipmentRequestToAddress
	isSet bool
}

func (v NullableMultipieceDomesticShipmentRequestToAddress) Get() *MultipieceDomesticShipmentRequestToAddress {
	return v.value
}

func (v *NullableMultipieceDomesticShipmentRequestToAddress) Set(val *MultipieceDomesticShipmentRequestToAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableMultipieceDomesticShipmentRequestToAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableMultipieceDomesticShipmentRequestToAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultipieceDomesticShipmentRequestToAddress(val *MultipieceDomesticShipmentRequestToAddress) *NullableMultipieceDomesticShipmentRequestToAddress {
	return &NullableMultipieceDomesticShipmentRequestToAddress{value: val, isSet: true}
}

func (v NullableMultipieceDomesticShipmentRequestToAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMultipieceDomesticShipmentRequestToAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
