...
// checks if the DomesticShipmentResponseV2LabelLayoutInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DomesticShipmentResponseV2LabelLayoutInner{}

// DomesticShipmentResponseV2LabelLayoutInner struct for DomesticShipmentResponseV2LabelLayoutInner
type DomesticShipmentResponseV2LabelLayoutInner struct {
...
func NewDomesticShipmentResponseV2LabelLayoutInner() *DomesticShipmentResponseV2LabelLayoutInner {
	this := DomesticShipmentResponseV2LabelLayoutInner{}
	return &this
}
...
func (o DomesticShipmentResponseV2LabelLayoutInner) MarshalJSON() ([]byte, error) {
...
func (o DomesticShipmentResponseV2LabelLayoutInner) ToMap() (map[string]interface{}, error) {
...
type NullableDomesticShipmentResponseV2LabelLayoutInner struct {
	value *DomesticShipmentResponseV2LabelLayoutInner
	isSet bool
}

func (v NullableDomesticShipmentResponseV2LabelLayoutInner) Get() *DomesticShipmentResponseV2LabelLayoutInner {
	return v.value
}

func (v *NullableDomesticShipmentResponseV2LabelLayoutInner) Set(val *DomesticShipmentResponseV2LabelLayoutInner) {
	v.value = val
	v.isSet = true
}

func (v NullableDomesticShipmentResponseV2LabelLayoutInner) IsSet() bool {
	return v.isSet
}

func (v *NullableDomesticShipmentResponseV2LabelLayoutInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDomesticShipmentResponseV2LabelLayoutInner(val *DomesticShipmentResponseV2LabelLayoutInner) *NullableDomesticShipmentResponseV2LabelLayoutInner {
	return &NullableDomesticShipmentResponseV2LabelLayoutInner{value: val, isSet: true}
}

func (v NullableDomesticShipmentResponseV2LabelLayoutInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDomesticShipmentResponseV2LabelLayoutInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
