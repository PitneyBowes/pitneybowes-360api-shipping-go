...
// checks if the SchedulePickupDHLEXPResponsePickupAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SchedulePickupDHLEXPResponsePickupAddress{}

// SchedulePickupDHLEXPResponsePickupAddress It specifies the address from where your parcels will be available for pickup
type SchedulePickupDHLEXPResponsePickupAddress struct {
...
func NewSchedulePickupDHLEXPResponsePickupAddress() *SchedulePickupDHLEXPResponsePickupAddress {
	this := SchedulePickupDHLEXPResponsePickupAddress{}
	return &this
}
...
func (o SchedulePickupDHLEXPResponsePickupAddress) MarshalJSON() ([]byte, error) {
...
func (o SchedulePickupDHLEXPResponsePickupAddress) ToMap() (map[string]interface{}, error) {
...
type NullableSchedulePickupDHLEXPResponsePickupAddress struct {
	value *SchedulePickupDHLEXPResponsePickupAddress
	isSet bool
}

func (v NullableSchedulePickupDHLEXPResponsePickupAddress) Get() *SchedulePickupDHLEXPResponsePickupAddress {
	return v.value
}

func (v *NullableSchedulePickupDHLEXPResponsePickupAddress) Set(val *SchedulePickupDHLEXPResponsePickupAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableSchedulePickupDHLEXPResponsePickupAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableSchedulePickupDHLEXPResponsePickupAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSchedulePickupDHLEXPResponsePickupAddress(val *SchedulePickupDHLEXPResponsePickupAddress) *NullableSchedulePickupDHLEXPResponsePickupAddress {
	return &NullableSchedulePickupDHLEXPResponsePickupAddress{value: val, isSet: true}
}

func (v NullableSchedulePickupDHLEXPResponsePickupAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSchedulePickupDHLEXPResponsePickupAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
