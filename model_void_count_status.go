...
// checks if the VoidCountStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VoidCountStatus{}

// VoidCountStatus Indicates the status of shipping labels/shipments which are sent to be cancelled.
type VoidCountStatus struct {
...
func (o VoidCountStatus) MarshalJSON() ([]byte, error) {
...
func (o VoidCountStatus) ToMap() (map[string]interface{}, error) {
...
type NullableVoidCountStatus struct {
	value *VoidCountStatus
	isSet bool
}

func (v NullableVoidCountStatus) Get() *VoidCountStatus {
	return v.value
}

func (v *NullableVoidCountStatus) Set(val *VoidCountStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableVoidCountStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableVoidCountStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVoidCountStatus(val *VoidCountStatus) *NullableVoidCountStatus {
	return &NullableVoidCountStatus{value: val, isSet: true}
}

func (v NullableVoidCountStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVoidCountStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
