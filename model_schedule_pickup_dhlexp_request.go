...
// SchedulePickupDHLEXPRequest It specifies the request body for scheduling pickup for DHL Express
type SchedulePickupDHLEXPRequest struct {
	...
	PickupOptions SchedulePickupDHLEXPRequestPickupOptions `json:"pickupOptions"`
}

type _SchedulePickupDHLEXPRequest SchedulePickupDHLEXPRequest
...
func (o *SchedulePickupDHLEXPRequest) GetPickupOptions() SchedulePickupDHLEXPRequestPickupOptions {
	if o == nil {
		var ret SchedulePickupDHLEXPRequestPickupOptions
		return ret
	}
...
func (o *SchedulePickupDHLEXPRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varSchedulePickupDHLEXPRequest := _SchedulePickupDHLEXPRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSchedulePickupDHLEXPRequest)

	if err != nil {
		return err
	}

	*o = SchedulePickupDHLEXPRequest(varSchedulePickupDHLEXPRequest)
