...
// checks if the MultipieceDomesticShipmentRequestFromAddress type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultipieceDomesticShipmentRequestFromAddress{}

// MultipieceDomesticShipmentRequestFromAddress struct for MultipieceDomesticShipmentRequestFromAddress
type MultipieceDomesticShipmentRequestFromAddress struct {
...
type _MultipieceDomesticShipmentRequestFromAddress MultipieceDomesticShipmentRequestFromAddress
...
func NewMultipieceDomesticShipmentRequestFromAddress(addressLine1 string, countryCode string, postalCode string, stateProvince string) *MultipieceDomesticShipmentRequestFromAddress {
	this := MultipieceDomesticShipmentRequestFromAddress{}
...
func (o MultipieceDomesticShipmentRequestFromAddress) MarshalJSON() ([]byte, error) {
...
func (o MultipieceDomesticShipmentRequestFromAddress) ToMap() (map[string]interface{}, error) {
...
func (o *MultipieceDomesticShipmentRequestFromAddress) UnmarshalJSON(data []byte) (err error) {
	...
	varMultipieceDomesticShipmentRequestFromAddress := _MultipieceDomesticShipmentRequestFromAddress{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMultipieceDomesticShipmentRequestFromAddress)

	if err != nil {
		return err
	}

	*o = MultipieceDomesticShipmentRequestFromAddress(varMultipieceDomesticShipmentRequestFromAddress)

	return err
}

type NullableMultipieceDomesticShipmentRequestFromAddress struct {
	value *MultipieceDomesticShipmentRequestFromAddress
	isSet bool
}

func (v NullableMultipieceDomesticShipmentRequestFromAddress) Get() *MultipieceDomesticShipmentRequestFromAddress {
	return v.value
}

func (v *NullableMultipieceDomesticShipmentRequestFromAddress) Set(val *MultipieceDomesticShipmentRequestFromAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableMultipieceDomesticShipmentRequestFromAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableMultipieceDomesticShipmentRequestFromAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultipieceDomesticShipmentRequestFromAddress(val *MultipieceDomesticShipmentRequestFromAddress) *NullableMultipieceDomesticShipmentRequestFromAddress {
	return &NullableMultipieceDomesticShipmentRequestFromAddress{value: val, isSet: true}
}

func (v NullableMultipieceDomesticShipmentRequestFromAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMultipieceDomesticShipmentRequestFromAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
