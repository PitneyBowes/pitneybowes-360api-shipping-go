...
type GetAllPickups struct {
	...
	Data []GetAllPickupsDataInner `json:"data,omitempty"`
}
...
func (o *GetAllPickups) GetData() []GetAllPickupsDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []GetAllPickupsDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []GetAllPickupsDataInner and assigns it to the Data field.
