...
// checks if the CancelShipmentV2References type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CancelShipmentV2References{}

// CancelShipmentV2References Contains key value map for passing references which is printed on Shipping Label. <br />For example Department Name, Invoice No., PO No., Package description, Order No./ Purchase Order No., Carrier note, Cost Account No., Transportation No., etc. . Max references allowed here is 2, and max length of each Reference field is 35. [IN/OUT].
type CancelShipmentV2References struct {
...
func NewCancelShipmentV2References() *CancelShipmentV2References {
	this := CancelShipmentV2References{}
	return &this
}
...
func (o CancelShipmentV2References) MarshalJSON() ([]byte, error) {
...
func (o CancelShipmentV2References) ToMap() (map[string]interface{}, error) {
...
type NullableCancelShipmentV2References struct {
	value *CancelShipmentV2References
	isSet bool
}

func (v NullableCancelShipmentV2References) Get() *CancelShipmentV2References {
	return v.value
}

func (v *NullableCancelShipmentV2References) Set(val *CancelShipmentV2References) {
	v.value = val
	v.isSet = true
}

func (v NullableCancelShipmentV2References) IsSet() bool {
	return v.isSet
}

func (v *NullableCancelShipmentV2References) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCancelShipmentV2References(val *CancelShipmentV2References) *NullableCancelShipmentV2References {
	return &NullableCancelShipmentV2References{value: val, isSet: true}
}

func (v NullableCancelShipmentV2References) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCancelShipmentV2References) UnmarshalJSON(src []byte) error {
	v.isSet = true
